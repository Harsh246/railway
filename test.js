...
const getSignalQuality = (rsrp) => {
  ...
  const generateBroadbandStatus = (customerId) => {
    ...
    return {
      ...
      connectionStatus: faker.helpers.arrayElement(["Active", "Inactive"]),
      connectionType: faker.helpers.arrayElement(["Prepaid", "Postpaid"]),
      ocsStatus: faker.helpers.arrayElement(["Active", "Not Active"]),
      signalInfo: {
        rsrpLevel: rsrp,
